...
int main()
{
    ...
    // scene.AddShape(box, new pbrt::ConductorMaterial{{0.1f, 1.2f, 1.8f}, {5.f, 2.5f, 2.f}, 0.3f, 0.3f}, {0.6f, 1.92f, 0.52f}, {0.018f, 0.07f, 0.04f});
    // scene.AddShape(sphere, new pbrt::DielectricMaterial{pbrt::RGB(255, 255, 255), 1.2f, 0.15f, 0.15f}, {-0.3f, 0.35f, -0.3f});
    ...
    {
        mis.Render("../../../cornellbox.exr", 4096);
    }
