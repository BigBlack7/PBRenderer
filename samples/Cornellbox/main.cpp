...
int main()
{
    ...
    // scene.AddShape(box, new pbrt::ConductorMaterial{{0.1f, 1.2f, 1.8f}, {5.f, 2.5f, 2.f}, 0.1f, 0.1f}, {0.6f, 1.92f, 0.52f}, {0.018f, 0.07f, 0.04f});
    scene.AddShape(sphere, new pbrt::DielectricMaterial{pbrt::RGB(255, 255, 255), 1.4f, 0.1f, 0.1f}, {-0.3f, 0.35f, -0.3f});
    ...
    scene.AddInfiniteLight(new pbrt::EnvLight{&env_map, 90.f});

    auto *light = new pbrt::AreaLight{quad, pbrt::RGB(255, 220, 150), false};
    ...
    {
        mis.Render("../../../cornellbox-m.exr", 128);
    }
